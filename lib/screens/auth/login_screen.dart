...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    try {
      ...
      // Configuration is supplied at build time with MSG91_AUTH_TOKEN.
    }
  }
                            ...
                            Expanded(
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(color: !isSignUp ? AppColors.navy : Colors.transparent, borderRadius: BorderRadius.circular(11)),
                                  child: Text('Sign In', style: TextStyle(color: !isSignUp ? Colors.white : AppColors.muted, fontWeight: FontWeight.w900, fontSize: 13)),
                                ),
                              ),
                            ),
                            Expanded(
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  alignment: Alignment.center,
                                  decoration: BoxDecoration(color: isSignUp ? AppColors.navy : Colors.transparent, borderRadius: BorderRadius.circular(11)),
                                  child: Text('Register', style: TextStyle(color: isSignUp ? Colors.white : AppColors.muted, fontWeight: FontWeight.w900, fontSize: 13)),
                                ),
                              ),
                            ),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: isLoading
                              ...
                              : const Text('CONTINUE WITH WHATSAPP', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14, letterSpacing: 0.5)),
                        ),
                      ),
