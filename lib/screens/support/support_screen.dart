      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Describe your issue below. Our Hyderabad support team will get back to you within 30 minutes.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // Emergency Helpline Banner Card
          AppCard(
            color: AppColors.navy,
            child: Row(
              children: [
          ...
          item(
            context,
            'Booking Support',
            'Help with a customer journey',
            Icons.calendar_today_outlined,
          ),
          item(
            context,
            'Payment Support',
            'Earnings and settlement help',
          ...
          AppPrimaryButton(
            ...
            onPressed: () => _openSupportDialog('General Inquiry'),
          ),
        ],
      ),
    );
