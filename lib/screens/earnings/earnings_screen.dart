              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  return Center(
                    child: Padding(
                      ...
                      child: Text('Could not load earnings. ${snapshot.error}', textAlign: TextAlign.center),
                    ),
                  );
                }
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (docs.isEmpty)
                      const AppCard(
                        child: Text('No completed trips yet.', style: TextStyle(color: AppColors.muted, fontWeight: FontWeight.w600)),
                      )
                    else
                      ...docs.map((doc) {
                        final data = doc.data();
